# Contributing to Manuh Bridge

Thanks for taking the time to contribute!

The following is a set of guidelines for contributing to Manuh Bridge and its packages. These are mostly guidelines, not rules. Use your best judgment, and feel free to propose changes to this document in a pull request.
...
This project and everyone participating in it is governed by the [Code of Conduct](CODE_OF_CONDUCT.md). By participating, you are expected to uphold this code. Please report unacceptable behavior to [jairsjunior@gmail.com](mailto:jairsjunior@gmail.com).

## What should I know before I get started?

### Manuh Bridge

Manuh Bridge is an small open source project. This project depends on below projects. If you consider contributing with Manuh Bridge, you should be know this other projects.
* [mqttjs/MQTT.js](https://github.com/mqttjs/MQTT.js)
* [tiagostutz/manuh](https://github.com/tiagostutz/manuh)

## How Can I Contribute?

### Reporting Bugs

This section guides you through submitting a bug report for Manuh Bridge. Following these guidelines helps maintainers and the community understand your report :pencil:, reproduce the behavior :computer: :computer:, and find related reports :mag_right:.
